...
This is a powerful blog theme, named Carbon Lite.
...
= There aren't a ton of options in the Customizer right now. Do you plan for releasing more of them ? =

Well, yes and no. I want to make this theme as customizable as possible, but I also want to keep it super simple to use.
I'll be adding a few options for sure, but not a ton, so as not to make it too complex.
